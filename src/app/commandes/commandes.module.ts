...
import {ProductPurchaseComponent} from "./graphique-achats/product-purchase/product-purchase.component";
import { PurchaseByMonthComponent } from './graphique-achats/purchase-by-month/purchase-by-month.component';
...
@NgModule({
  declarations: [CommandesComponent, CreateCommandeComponent, CreateCommandDialogContainerComponent, CommandReceptionComponent,
    ...
    FactureDialogComponent, FactureHistoriqueComponent, GraphiqueAchatsComponent, ProductPurchaseComponent, PurchaseByMonthComponent],
  imports: [
    CommonModule, SharedModule, ReactiveFormsModule,
    CommandesRoutingModule, BarChartModule, NgxChartsModule
  ]
})

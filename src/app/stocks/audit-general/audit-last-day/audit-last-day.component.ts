...
@Component({
  selector: 'app-audit-last-day',
  templateUrl: './audit-last-day.component.html',
  styleUrls: ['./audit-last-day.component.scss']
})
export class AuditLastDayComponent implements OnInit {
 isLoading = false;
